...
<div style="margin-bottom:20px">
	...
	<form action="allUsers.jsp" method="get">
       <button class="w3-button w3-light-blue" type=submit>see all user</button>
      </form>
 </div>     
      ...
      <form action="RegisterServlet" method="post">
       username <input type=text name="bookName">
      password <input type=text name="author">
